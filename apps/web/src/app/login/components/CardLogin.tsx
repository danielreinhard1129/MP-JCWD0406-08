  ...
  return (
    <div className="flex flex-col items-center h-screen w-full justify-center">
      <div className="p-3 bg-white rounded-md border-4 border-black">
        <h1 className="text-3xl md:text-4xl lg:text-4xl font-bold mb-6 leading-tight text-blue-500 ">
          Welcome To Event
          <h2 className="pt-4 lg:text-2xl font-semibold text-black">SignIn</h2>
        </h1>
